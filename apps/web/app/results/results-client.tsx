...
const PROVIDER_NAMES: Record<string, string> = {
  ...
  california_corrections: "California corrections",
  maryland_corrections: "Maryland corrections",
  alabama_corrections: "Alabama corrections",
  delaware_delpros_licenses: "Delaware professional licenses",
  georgia_corrections: "Georgia corrections",
  illinois_corrections: "Illinois corrections",
  iowa_corrections: "Iowa corrections",
  missouri_finance_entities: "Missouri finance licenses",
  nevada_corrections: "Nevada corrections",
  new_york_dos_licenses: "New York professional licenses",
  north_dakota_corrections: "North Dakota corrections",
  ohio_corrections: "Ohio corrections",
  oregon_corrections: "Oregon corrections",
  pennsylvania_corrections: "Pennsylvania corrections",
  south_carolina_corrections: "South Carolina corrections",
  vermont_corrections: "Vermont corrections",
  virginia_dpor_licenses: "Virginia professional licenses",
  washington_corrections: "Washington corrections",
  wyoming_corrections: "Wyoming corrections",
